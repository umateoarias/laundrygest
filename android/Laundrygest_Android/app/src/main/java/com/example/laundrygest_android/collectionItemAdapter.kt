...
class collectionItemAdapter(val list : List<CollectionItemDto>) : RecyclerView.Adapter<collectionItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.qntPiece.setText(list[position].numPieces)
